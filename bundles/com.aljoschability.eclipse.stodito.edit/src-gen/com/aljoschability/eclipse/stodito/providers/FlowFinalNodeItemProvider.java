...
/**
 * This is the item provider adapter for a {@link com.aljoschability.eclipse.stodito.FlowFinalNode} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class FlowFinalNodeItemProvider extends ActivityNodeItemProvider implements IEditingDomainItemProvider,
	...
	public String getText(Object object) {
		String label = ((FlowFinalNode) object).getComment();
		return label == null || label.length() == 0 ? getString("_UI_FlowFinalNode_type") : //$NON-NLS-1$
				getString("_UI_FlowFinalNode_type") + " " + label; //$NON-NLS-1$ //$NON-NLS-2$
	}
