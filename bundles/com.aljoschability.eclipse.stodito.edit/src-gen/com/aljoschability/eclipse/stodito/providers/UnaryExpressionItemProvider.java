...
/**
 * This is the item provider adapter for a {@link com.aljoschability.eclipse.stodito.UnaryExpression} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class UnaryExpressionItemProvider extends ExpressionItemProvider implements IEditingDomainItemProvider,
	...
	protected void addTypePropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(
						...
						getResourceLocator(),
						getString("_UI_UnaryExpression_type_feature"), //$NON-NLS-1$
						getString(
								"_UI_PropertyDescriptor_description", "_UI_UnaryExpression_type_feature", "_UI_UnaryExpression_type"), //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$
						StoditoPackage.Literals.UNARY_EXPRESSION__TYPE, true, false, false,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(StoditoPackage.Literals.UNARY_EXPRESSION__EXPRESSION);
		}
	...
	public String getText(Object object) {
		...
		return label == null || label.length() == 0 ? getString("_UI_UnaryExpression_type") : //$NON-NLS-1$
				getString("_UI_UnaryExpression_type") + " " + label; //$NON-NLS-1$ //$NON-NLS-2$
	}
	...
	public void notifyChanged(Notification notification) {
		...
		case StoditoPackage.UNARY_EXPRESSION__TYPE:
			fireNotifyChanged(new ViewerNotification(notification, notification.getNotifier(), false, true));
			return;
		case StoditoPackage.UNARY_EXPRESSION__EXPRESSION:
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add(createChildParameter(StoditoPackage.Literals.UNARY_EXPRESSION__EXPRESSION,
