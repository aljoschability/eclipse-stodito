...
import com.aljoschability.eclipse.stodito.Commentable;
...
/**
 * This is the item provider adapter for a {@link com.aljoschability.eclipse.stodito.Commentable} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class CommentableItemProvider extends ItemProviderAdapter implements IEditingDomainItemProvider,
	...
	public String getText(Object object) {
		...
		return label == null || label.length() == 0 ? getString("_UI_Commentable_type") : //$NON-NLS-1$
				getString("_UI_Commentable_type") + " " + label; //$NON-NLS-1$ //$NON-NLS-2$
	}
	...
	public void notifyChanged(Notification notification) {
		...
		case StoditoPackage.COMMENTABLE__COMMENT:
