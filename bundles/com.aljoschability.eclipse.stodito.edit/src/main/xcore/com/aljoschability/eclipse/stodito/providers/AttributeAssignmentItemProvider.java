...
/**
 * This is the item provider adapter for a {@link com.aljoschability.eclipse.stodito.AttributeAssignment} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class AttributeAssignmentItemProvider extends ItemProviderAdapter implements IEditingDomainItemProvider,
	...
	protected void addAttributePropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(),
						getString("_UI_AttributeAssignment_attribute_feature"), //$NON-NLS-1$
						getString(
								"_UI_PropertyDescriptor_description", "_UI_AttributeAssignment_attribute_feature", "_UI_AttributeAssignment_type"), //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$
						StoditoPackage.Literals.ATTRIBUTE_ASSIGNMENT__ATTRIBUTE, true, false, true, null, null, null));
	}
	...
	protected void addOccurrencePropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(),
						getString("_UI_AttributeAssignment_occurrence_feature"), //$NON-NLS-1$
						getString(
								"_UI_PropertyDescriptor_description", "_UI_AttributeAssignment_occurrence_feature", "_UI_AttributeAssignment_type"), //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$
						StoditoPackage.Literals.ATTRIBUTE_ASSIGNMENT__OCCURRENCE, true, false, true, null, null, null));
	}
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(StoditoPackage.Literals.ATTRIBUTE_ASSIGNMENT__EXPRESSION);
		}
	...
	public String getText(Object object) {
		return getString("_UI_AttributeAssignment_type"); //$NON-NLS-1$
	}
	...
	public void notifyChanged(Notification notification) {
		...
		case StoditoPackage.ATTRIBUTE_ASSIGNMENT__EXPRESSION:
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add(createChildParameter(StoditoPackage.Literals.ATTRIBUTE_ASSIGNMENT__EXPRESSION,
