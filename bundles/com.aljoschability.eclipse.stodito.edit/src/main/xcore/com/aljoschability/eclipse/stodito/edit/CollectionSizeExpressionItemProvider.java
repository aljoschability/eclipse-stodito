...
import com.aljoschability.eclipse.stodito.CollectionSizeExpression;
...
/**
 * This is the item provider adapter for a {@link com.aljoschability.eclipse.stodito.CollectionSizeExpression} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class CollectionSizeExpressionItemProvider extends ExpressionItemProvider {
	/**
	...
	protected void addCollectionPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(
						...
						getResourceLocator(),
						getString("_UI_CollectionSizeExpression_collection_feature"), //$NON-NLS-1$
						getString(
								"_UI_PropertyDescriptor_description", "_UI_CollectionSizeExpression_collection_feature", "_UI_CollectionSizeExpression_type"), //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$
						StoditoPackage.Literals.COLLECTION_SIZE_EXPRESSION__COLLECTION, true, false, true, null, null,
						null));
	}
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(StoditoPackage.Literals.COLLECTION_SIZE_EXPRESSION__EXPRESSION);
		}
	...
	public String getText(Object object) {
		...
		return label == null || label.length() == 0 ? getString("_UI_CollectionSizeExpression_type") : //$NON-NLS-1$
				getString("_UI_CollectionSizeExpression_type") + " " + label; //$NON-NLS-1$ //$NON-NLS-2$
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(CollectionSizeExpression.class)) {
		case StoditoPackage.COLLECTION_SIZE_EXPRESSION__EXPRESSION:
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add(createChildParameter(StoditoPackage.Literals.COLLECTION_SIZE_EXPRESSION__EXPRESSION,
