...
/**
 * This is the item provider adapter for a {@link com.aljoschability.eclipse.stodito.StatementNode} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class StatementNodeItemProvider extends ActivityNodeItemProvider {
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(StoditoPackage.Literals.STATEMENT_NODE__EXPRESSION);
		}
	...
	public String getText(Object object) {
		...
		return label == null || label.length() == 0 ? getString("_UI_StatementNode_type") : //$NON-NLS-1$
				getString("_UI_StatementNode_type") + " " + label; //$NON-NLS-1$ //$NON-NLS-2$
	}
	...
	public void notifyChanged(Notification notification) {
		...
		case StoditoPackage.STATEMENT_NODE__NAME:
			fireNotifyChanged(new ViewerNotification(notification, notification.getNotifier(), false, true));
			return;
		case StoditoPackage.STATEMENT_NODE__EXPRESSION:
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add(createChildParameter(StoditoPackage.Literals.STATEMENT_NODE__EXPRESSION,
