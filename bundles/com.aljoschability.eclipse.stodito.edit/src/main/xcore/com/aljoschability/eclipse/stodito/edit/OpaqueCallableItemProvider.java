...
import com.aljoschability.eclipse.stodito.OpaqueCallable;
...
/**
 * This is the item provider adapter for a {@link com.aljoschability.eclipse.stodito.OpaqueCallable} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class OpaqueCallableItemProvider extends CallableItemProvider {
	...
	public String getText(Object object) {
		...
		return label == null || label.length() == 0 ? getString("_UI_OpaqueCallable_type") : //$NON-NLS-1$
				getString("_UI_OpaqueCallable_type") + " " + label; //$NON-NLS-1$ //$NON-NLS-2$
	}
