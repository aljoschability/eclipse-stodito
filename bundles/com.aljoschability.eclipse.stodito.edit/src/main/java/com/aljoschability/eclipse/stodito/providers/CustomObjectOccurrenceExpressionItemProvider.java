...
public class CustomObjectOccurrenceExpressionItemProvider extends ObjectOccurrenceExpressionItemProvider {
	public CustomObjectOccurrenceExpressionItemProvider(AdapterFactory adapterFactory) {
