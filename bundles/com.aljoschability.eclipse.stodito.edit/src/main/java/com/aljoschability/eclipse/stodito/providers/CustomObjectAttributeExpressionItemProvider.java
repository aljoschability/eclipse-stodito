...
public class CustomObjectAttributeExpressionItemProvider extends ObjectAttributeExpressionItemProvider {
	public CustomObjectAttributeExpressionItemProvider(AdapterFactory adapterFactory) {
