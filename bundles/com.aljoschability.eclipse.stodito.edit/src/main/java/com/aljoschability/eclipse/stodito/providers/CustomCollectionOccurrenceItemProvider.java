...
public class CustomCollectionOccurrenceItemProvider extends CollectionOccurrenceItemProvider {
	public CustomCollectionOccurrenceItemProvider(AdapterFactory adapterFactory) {
