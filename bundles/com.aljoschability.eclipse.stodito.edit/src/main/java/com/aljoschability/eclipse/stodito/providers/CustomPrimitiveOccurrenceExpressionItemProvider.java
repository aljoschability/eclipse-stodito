...
public class CustomPrimitiveOccurrenceExpressionItemProvider extends PrimitiveOccurrenceExpressionItemProvider {
	public CustomPrimitiveOccurrenceExpressionItemProvider(AdapterFactory adapterFactory) {
