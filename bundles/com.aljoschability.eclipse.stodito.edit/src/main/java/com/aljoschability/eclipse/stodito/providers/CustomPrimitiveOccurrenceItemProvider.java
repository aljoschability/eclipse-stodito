...
public class CustomPrimitiveOccurrenceItemProvider extends PrimitiveOccurrenceItemProvider {
	public CustomPrimitiveOccurrenceItemProvider(AdapterFactory adapterFactory) {
