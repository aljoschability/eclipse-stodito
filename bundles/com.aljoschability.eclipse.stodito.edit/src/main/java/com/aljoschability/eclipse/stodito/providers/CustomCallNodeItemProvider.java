...
public class CustomCallNodeItemProvider extends CallNodeItemProvider {
	public CustomCallNodeItemProvider(AdapterFactory adapterFactory) {
		super(adapterFactory);
	}

	@Override
	public String getText(Object object) {
		return MessageFormat.format("Call Node {0}", ((CallNode) object).getName());
	}

	@Override
	public Object getImage(Object object) {
		return StoditoImages.get(StoditoPackage.Literals.CALL_NODE.getName());
	}
}
