...
import com.aljoschability.eclipse.stodito.ui.providers.ResourcesContentProvider;
...
public class SelectEClassifierBindingDialog extends AbstractTreeSelectionDialog<EObject> {
	...
	protected String getErrorMessage(Object element) {
		...
		return String.format("You have to select an element of the type %1s.", String.valueOf(eClassifier));
	}
}
